...
#
# Created: Tue Nov 18 00:24:35 2014
...
class Ui_TraverseCalcDialog(object):
    def setupUi(self, TraverseCalcDialog):
        ...
        self.TargetPointsList = QtGui.QListView(self.PointsGroup)
        self.TargetPointsList.setGeometry(QtCore.QRect(10, 40, 131, 171))
        self.TargetPointsList.setObjectName(_fromUtf8("TargetPointsList"))
        ...
        self.OrderPointsList = QtGui.QListView(self.PointsGroup)
        self.OrderPointsList.setGeometry(QtCore.QRect(250, 40, 131, 171))
        self.OrderPointsList.setObjectName(_fromUtf8("OrderPointsList"))
        ...
        TraverseCalcDialog.setTabOrder(self.ClosedRadio, self.LoopRadio)
        TraverseCalcDialog.setTabOrder(self.LoopRadio, self.OpenRadio)
        TraverseCalcDialog.setTabOrder(self.OpenRadio, self.BeillesztettRadio)
        TraverseCalcDialog.setTabOrder(self.BeillesztettRadio, self.StartPointComboBox)
        TraverseCalcDialog.setTabOrder(self.StartPointComboBox, self.EndPointComboBox)
        TraverseCalcDialog.setTabOrder(self.EndPointComboBox, self.TargetPointsList)
        TraverseCalcDialog.setTabOrder(self.TargetPointsList, self.AddButton)
        ...
        TraverseCalcDialog.setTabOrder(self.RemoveButton, self.OrderPointsList)
        TraverseCalcDialog.setTabOrder(self.OrderPointsList, self.ResultTextBrowser)
