...
#
# Created: Wed Dec 10 21:56:49 2014
...
class Ui_AddNewPointDialog(object):
    def setupUi(self, AddNewPointDialog):
        ...
        self.NorthCoordLabel.setGeometry(QtCore.QRect(10, 80, 151, 16))
        self.NorthCoordLabel.setObjectName(_fromUtf8("NorthCoordLabel"))
        self.PointCodeLabel = QtGui.QLabel(self.AddNewPointGroup)
        self.PointCodeLabel.setGeometry(QtCore.QRect(10, 140, 151, 16))
        ...
        self.PointTypeLabel.setGeometry(QtCore.QRect(10, 170, 151, 16))
        ...
        self.EastCoordLabel.setGeometry(QtCore.QRect(10, 50, 151, 16))
        self.EastCoordLabel.setObjectName(_fromUtf8("EastCoordLabel"))
        self.PointNumberLabel = QtGui.QLabel(self.AddNewPointGroup)
        self.PointNumberLabel.setGeometry(QtCore.QRect(10, 20, 151, 16))
        ...
        self.ZCoordLabel.setGeometry(QtCore.QRect(10, 110, 151, 16))
    ...
    def retranslateUi(self, AddNewPointDialog):
        ...
        self.NorthCoordLabel.setText(QtGui.QApplication.translate("AddNewPointDialog", "North coordinate", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.EastCoordLabel.setText(QtGui.QApplication.translate("AddNewPointDialog", "East coordinate", None, QtGui.QApplication.UnicodeUTF8))
        self.PointNumberLabel.setText(QtGui.QApplication.translate("AddNewPointDialog", "Point Number", None, QtGui.QApplication.UnicodeUTF8))
        self.ZCoordLabel.setText(QtGui.QApplication.translate("AddNewPointDialog", "Z coordinate (elevation)", None, QtGui.QApplication.UnicodeUTF8))
