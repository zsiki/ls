...
class Ui_NetworkCalcDialog(object):
    def setupUi(self, NetworkCalcDialog):
        ...
        NetworkCalcDialog.setWindowTitle(QtGui.QApplication.translate("NetworkCalcDialog", "Network Adjustment", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.AngleDevLineEdit = QtGui.QLineEdit(self.ParametersGroup)
        self.AngleDevLineEdit.setGeometry(QtCore.QRect(10, 120, 41, 31))
        self.AngleDevLineEdit.setText(QtGui.QApplication.translate("NetworkCalcDialog", "3", None, QtGui.QApplication.UnicodeUTF8))
        self.AngleDevLineEdit.setObjectName(_fromUtf8("AngleDevLineEdit"))
        self.DistDevMMLineEdit = QtGui.QLineEdit(self.ParametersGroup)
        self.DistDevMMLineEdit.setGeometry(QtCore.QRect(10, 180, 41, 31))
        self.DistDevMMLineEdit.setText(QtGui.QApplication.translate("NetworkCalcDialog", "3", None, QtGui.QApplication.UnicodeUTF8))
        self.DistDevMMLineEdit.setObjectName(_fromUtf8("DistDevMMLineEdit"))
        self.DistDevMMKMLineEdit = QtGui.QLineEdit(self.ParametersGroup)
        self.DistDevMMKMLineEdit.setGeometry(QtCore.QRect(100, 180, 41, 31))
        self.DistDevMMKMLineEdit.setText(QtGui.QApplication.translate("NetworkCalcDialog", "3", None, QtGui.QApplication.UnicodeUTF8))
        self.DistDevMMKMLineEdit.setObjectName(_fromUtf8("DistDevMMKMLineEdit"))
