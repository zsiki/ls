...
#
# Created: Sun Dec 14 12:08:36 2014
...
class Ui_AddNewPointDialog(object):
    def setupUi(self, AddNewPointDialog):
        ...
        AddNewPointDialog.setTabOrder(self.AddButton, self.CloseButton)
        AddNewPointDialog.setTabOrder(self.CloseButton, self.ResetButton)
